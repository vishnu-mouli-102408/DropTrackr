...
export default function Footer() {
	return (
		<footer
			id="footer"
			className="border-border relative flex w-full flex-col items-center justify-center overflow-clip border-t bg-[radial-gradient(35%_128px_at_50%_0%,theme(backgroundColor.white/8%),transparent)] px-2 py-8 md:px-16 md:py-20"
		>
